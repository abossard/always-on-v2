# ADR-0030: IaC Placement of Service Connector Wiring
...
- **Cons**: Imperative — not in IaC state; drift risk; harder to audit; violates ADR-0010 IaC principle; no `what-if` preview.
...
- Related: [ADR-0029 Service Identity Wiring](0029-service-identity-wiring-UI.md), [ADR-0010 Infrastructure as Code](0010-infrastructure-as-code-UI.md)
