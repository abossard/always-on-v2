# ADR-0030: Service-to-Resource Identity Wiring
...
Connecting AKS workloads to Azure backing services (Cosmos DB, Service Bus, App Configuration, Key Vault, Redis) with Workload Identity (ADR-0015 Option 1) requires orchestrating multiple interdependent resources:
...
- Related: [ADR-0015 Security Approach](0015-security-approach-UI.md), [ADR-0023 Secrets Management](0023-secrets-management-UI.md), [ADR-0013 Multi-Region Strategy](0013-multi-region-strategy-UI.md)
