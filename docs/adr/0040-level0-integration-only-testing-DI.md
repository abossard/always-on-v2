...
- [ADR-0038: Matrix Testing](0038-matrix-testing-DI.md) — Behavior tests across all port implementations
- [ADR-0026: Level0 Lightweight API](0026-playeronlevel0-lightweight-api-DI.md) — Minimal hexagonal architecture
- [ADR-0034: Simplified Hexagonal Architecture](0034-simplified-hexagonal-architecture-DI.md) — Ports and adapters
