# ADR-0026: PlayersOnLevel0 — Lightweight Pure ASP.NET API for Player Progression
...
- [ADR-0005: Database Choice](0005-database-choice-UI.md) — Cosmos DB for NoSQL rationale
- [ADR-0008: API Design Style](0008-api-design-UI.md) — Minimal API approach
- [ADR-0016: Container Strategy](0016-container-strategy-UI.md) — AOT container builds
