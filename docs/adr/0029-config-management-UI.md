# ADR-0029: Configuration Management
...
- **Secrets** remain in Key Vault (ADR-0023); referenced from App Configuration via Key Vault references.
...
- **Negative**: New Azure resource to provision and manage (Bicep in ADR-0011); runtime dependency on App Configuration (mitigated by caching); team must adopt label conventions and sentinel key discipline.
...
- Related: [ADR-0013 Multi-Region Strategy](0013-multi-region-strategy-UI.md), [ADR-0023 Secrets Management](0023-secrets-management-UI.md)
