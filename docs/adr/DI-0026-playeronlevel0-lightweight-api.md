...
- [ADR-0005: Database Choice](0005-database-choice.md) — Cosmos DB for NoSQL rationale
- [ADR-0008: API Design Style](0008-api-design.md) — Minimal API approach
- [ADR-0016: Container Strategy](0016-container-strategy.md) — AOT container builds
