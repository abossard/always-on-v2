# ADR-0051: Direct Azure Monitor OTEL Exporters for Trace Telemetry
...
- [ADR-0044](0044-native-aot-for-level0-api-DI.md) — Native AOT considerations (TrimmerRoots for Azure Monitor)
- [ADR-0049](0049-cicd-infrastructure-deployment-lessons-DarkUX.md) — CI/CD lessons learned
