...
- [ADR-0026: PlayersOnLevel0 Lightweight API](0026-playeronlevel0-lightweight-api.md) — The reference implementation
- [ADR-0032: Coding Principles](0032-coding-principles.md) — Deep modules, not thin wrappers
- [ADR-0033: Module Design](0033-module-design.md) — Full business functionality per module
