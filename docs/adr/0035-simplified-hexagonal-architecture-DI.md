...
- [ADR-0027: PlayersOnLevel0 Lightweight API](0027-playeronlevel0-lightweight-api-DI.md) — The reference implementation
- [ADR-0033: Coding Principles](0033-coding-principles-DI.md) — Deep modules, not thin wrappers
- [ADR-0034: Module Design](0034-module-design-DI.md) — Full business functionality per module
