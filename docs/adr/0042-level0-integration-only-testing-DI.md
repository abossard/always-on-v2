# ADR-0042: Level0 Integration-Only Testing — No Unit Tests, No Mocks
...
- [ADR-0039: Matrix Testing](0039-matrix-testing-DI.md) — Behavior tests across all port implementations
- [ADR-0027: Level0 Lightweight API](0027-playeronlevel0-lightweight-api-DI.md) — Minimal hexagonal architecture
- [ADR-0035: Simplified Hexagonal Architecture](0035-simplified-hexagonal-architecture-DI.md) — Ports and adapters
