# ADR-0037: Idempotent Finite State Machines for State Verification
...
- [ADR-0032: Coding Principles](0032-coding-principles-DI.md) — No exceptions for expected failures
- [ADR-0036: Type-Safe Lookups](0036-type-safe-lookups-DI.md) — Enums over strings for states
