...
- [ADR-0044](DI-0044-native-aot-for-level0-api.md) — Native AOT considerations (TrimmerRoots for Azure Monitor)
- [ADR-0049](0049-cicd-infrastructure-deployment-lessons.md) — CI/CD lessons learned
